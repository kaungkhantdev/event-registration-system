...
<div class="min-h-screen bg-gray-50">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 py-10 lg:px-8">
        <div class="">
            <a href="{{ route('admin.dashboard') }}" class="inline-flex items-center text-sm text-gray-600 hover:text-indigo-600 mb-6 transition-colors">
        ...
        <div class="flex justify-between items-center mb-8">
            ...
            class="bg-indigo-600 hover:bg-indigo-700 text-white font-bold py-2 px-6 rounded-full">
