                                ...
                                <div class="flex-1">
                                    ...
                                    <div class="flex items-center space-x-4 text-sm text-gray-600">
                                        <div class="flex items-center text-gray-600">
                                            <i class="fas fa-calendar-day w-5 text-indigo-600"></i>
                                            <span class="ml-3 text-sm">{{ $registration->event->event_date->format('M d, Y g:i A') }}</span>
                                        </div>
                                        <div class="flex items-center text-gray-600">
                                            <i class="fas fa-map-marker-alt w-5 text-indigo-600"></i>
                                            <span class="ml-3 text-sm">{{ $registration->event->location }}</span>
                                        </div>
                                    </div>
                                </div>
